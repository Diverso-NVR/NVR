...
export default {
  ...
  beforeMount() {
    this.rooms.forEach(element => {
      ...
      element.defCod = element.sources.find(el => {
        return el.sound === "cam" || el.sound === "enc";
      });
      element.defCam = element.sources.find(el => {
        return el.main_cam;
      });
      element.url = "";
    });
