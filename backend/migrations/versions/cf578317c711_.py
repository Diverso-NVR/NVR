...
def downgrade():
    ...
    sa.Column('resource_id', sa.VARCHAR(length=100), server_default=sa.text('NULL::character varying'), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['room_id'], ['rooms.id'], name='channels_room_id_fkey'),
